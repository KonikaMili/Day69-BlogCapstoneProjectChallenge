...
def register():
    ...
    if request.method == "POST" and form.validate_on_submit():
        if current_user.is_authenticated and Users.query.filter_by(email=form.email.data).first():
...
def login():
    ...
    if request.method == "POST" and form.validate_on_submit():
        ...
        if not user:
            flash("That email does not exist. Please Sign Up first!")
